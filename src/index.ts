...
export { DshHeadlessBackend, headlessPrompt, outcomeEnvelope } from './dsh.js'
export { applyOutcome, readOutcome, MAX_PLANNED_TASKS } from './outcome.js'
export type { AgentOutcome, PlannedTask } from './outcome.js'
