...
**0.5.4 is the current release.** It adds the operator surface: a dashboard over one loop per project. Before it, 0.3 combined the unattended scheduler,
