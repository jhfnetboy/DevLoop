...
const live: AttentionInput = { error: false, armed: true, completed: false, halted: false, loop: 'running', state: { updatedAt: at }, holdReason: null }
...
describe('which column of the home page a project is in', () => {
  it.each([
    ...
    ['a halt the operator chose to leave', { ...live, halted: true, holdReason: 'empty_task', state: { updatedAt: at, acknowledged: { at: '2026-09-12T08:00:00.000Z', reason: 'empty_task', taskId: 't1' } } }, 'idle', '2026-09-12T08:00:00.000Z'],
    ['a different halt since the operator answered one', { ...live, halted: true, holdReason: 'daily_cost_cap', state: { updatedAt: at, acknowledged: { at: '2026-09-12T08:00:00.000Z', reason: 'empty_task', taskId: 't1' } } }, 'needs_you', at],
